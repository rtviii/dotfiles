...
parser_cmd_etl.add_argument('-struct'  , store='rcsb_id')
parser_cmd_etl.add_argument('--tunnel'      )
parser_cmd_etl.add_argument('--updated_cif' )
parser_cmd_etl.add_argument('--cif'         )
parser_cmd_etl.add_argument('--chains'      )
parser_cmd_etl.add_argument('--factors'     )
parser_cmd_etl.add_argument('--ligands'     )
parser_cmd_etl.add_argument('--thumbnail'   )
