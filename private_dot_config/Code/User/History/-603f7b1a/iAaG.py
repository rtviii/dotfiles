...
parser_cmd_etl.add_argument('-struct', '--obtain_structure',dest='rcsb_id', help="Get a particular structure by its RCSB_ID")
parser_cmd_etl.add_argument('-tunnel', '--obtain_tunnel',dest='rcsb_id', help="Get a particular structure by its RCSB_ID")
parser_cmd_etl.add_argument('-updated_cif', '--obtain_tunnel',dest='rcsb_id', help="Get a particular structure by its RCSB_ID")

parser_cmd_etl.add_argument('-cif'      , '--obtain_tunnel',dest='rcsb_id', help="Get a particular structure by its RCSB_ID")
parser_cmd_etl.add_argument('-chains'   , '--obtain_tunnel',dest='rcsb_id', help="Get a particular structure by its RCSB_ID")
parser_cmd_etl.add_argument('-factors'  , '--obtain_tunnel',dest='rcsb_id', help="Get a particular structure by its RCSB_ID")
parser_cmd_etl.add_argument('-ligands'  , '--obtain_tunnel',dest='rcsb_id', help="Get a particular structure by its RCSB_ID")
parser_cmd_etl.add_argument('-thumbnail', '--obtain_tunnel',dest='rcsb_id', help="Get a particular structure by its RCSB_ID")
