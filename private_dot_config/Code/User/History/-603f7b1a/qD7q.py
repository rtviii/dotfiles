...
parser_cmd_etl.add_argument('-struct'      , '--obtain_structure',dest='rcsb_id')
parser_cmd_etl.add_argument('-tunnel'      , dest='rcsb_id')
parser_cmd_etl.add_argument('-updated_cif' , dest='rcsb_id')
parser_cmd_etl.add_argument('-cif'         , dest='rcsb_id')
parser_cmd_etl.add_argument('-chains'      , dest='rcsb_id')
parser_cmd_etl.add_argument('-factors'     , dest='rcsb_id')
parser_cmd_etl.add_argument('-ligands'     , dest='rcsb_id')
parser_cmd_etl.add_argument('-thumbnail'   , dest='rcsb_id')
